          ...
          <div className="flex items-center">
            ...
            <nav className="flex flex-wrap items-center">
              <NavLink
                ...
                activeClassName="!text-white light:!text-gray-900 bg-black border-[rgba(255,255,255,0.2)] hover:border-[rgba(255,255,255,0.2)] light:bg-[rgba(204,204,204,0.35)] light:border-[rgba(0,0,0,0.2)] light:hover:border-[rgba(0,0,0,0.3)]"
              >
                <DocsIcon
                  height="16"
                  width="16"
              ...
              <NavLink
                partiallyActive
                to="/docs/core"
                activeClassName="!text-white light:!text-gray-900 bg-black border-[rgba(255,255,255,0.1)] hover:border-[rgba(255,255,255,0.2)] light:bg-[rgba(204,204,204,0.35)] light:border-[rgba(0,0,0,0.1)] light:hover:border-[rgba(0,0,0,0.3)]"
              >
                <CoursesIcon
                  height="16"
                  width="16"
